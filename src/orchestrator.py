...
def main():
    ...
    print("| Dataset | Architecture (Phase 1.9) | Best Threshold | Test Accuracy | Precision | Recall | F1 Score | PR-AUC | ROC-AUC | Target Met? |")
    print("| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |")
    ...
    for key in datasets_keys:
        ...
        if m:
            v5_list.append(m)
            print(f"| {m.get('Dataset', '-')} | {m.get('Architecture', '-')} | {m.get('Best_Threshold', 0):.4f} | "
    ...
    out_bench_dir = "../experiments" if os.path.exists("../experiments") else "experiments"
    ...
    # Save root copies
    root_json = "../five_dataset_results_v5.json" if os.path.exists("../experiments") else "five_dataset_results_v5.json"
    ...
    print("================================================================================")
    print("| Dataset | Metric | Previous (Phase 1.7) | Phase 1.9 | Delta (Change) | Status |")
    print("| :--- | :--- | :--- | :--- | :--- | :--- |")
    ...
    for key in datasets_keys:
        ...
        for mname, v_old, v_new in metrics_pairs:
            ...
            print(f"| {dname} | {mname} | {v_old*100:.2f}% | {v_new*100:.2f}% | {diff_str} | {status} |")
        print("| --- | --- | --- | --- | --- | --- |")
