...
from utils import set_seed, cleanup_memory, PrefitIsotonicCalibrator, optimize_threshold_phase_1_9
...
def run_pipeline():
    ...
    print("Training XGBoost on 166 topological features (scale_pos_weight=6.0, max_depth=7, lr=0.035)...")
    ...
    out_model_dir = "../models/Elliptic" if os.path.exists("../models") else "models/Elliptic"
    out_exp_dir = "../experiments/Elliptic" if os.path.exists("../experiments") else "experiments/Elliptic"
